    ...
    <div class="main-wrapper mdc-drawer-app-content">
      ...
      <!-- partial -->
        ...
        <body>
            ...
            <div id="contactsList">
                <?php
                // Fetch contacts from database or file
                ...
                foreach ($contacts as $index => $contact) {
                    ...
                    echo '<p><strong>Name:</strong> ' . $contactInfo[0] . '</p>';
                    echo '<p><strong>Email:</strong> ' . $contactInfo[1] . '</p>';
                    echo '<p><strong>Phone:</strong> ' . $contactInfo[2] . '</p>';
                    echo '<p><strong>Message:</strong> ' . $contactInfo[3] . '</p>';
                    echo '<button class="deleteBtn" onclick="deleteContact(' . $index . ')">Delete</button>';
                    echo '</div>';
                }
                ?>
            </div>
            ...
            <script>
                function deleteContact(index) {
                    if (confirm('Are you sure you want to delete this contact?')) {
                        ...
                        xhr.open('DELETE', 'delete_contact.php?index=' + index, true);
                        xhr.onload = function() {
                            if (xhr.status == 200) {
                                alert('Contact deleted successfully!');
                                location.reload(); // Refresh page to update contact list
                            } else {
          ...
          <div class="mdc-layout-grid">
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                <span class="text-center text-sm-left d-block d-sm-inline-block tx-14">Copyright © <a href="" target="_blank">PHOTOGRAPHY</a>2024</span>
              </div>
              </div>
            </div>
          </div>
