...
<div class="container">
    ...
    <div class="form-container">
        <h3>Insert About Content</h3>
        <form id="insertForm" action="insert_about.php" method="post">
            <label for="about_title">Title:</label>
            <input type="text" name="title" id="about_title"><br><br>
            <label for="about_description">Description:</label>
            <textarea name="description" id="about_description"></textarea><br><br>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td>
                            <form action='update_about.php' method='post' style='display:inline;'>
                                <input type='hidden' name='id' value='{$row['id']}'>
                                <input type='text' name='title' value='{$row['title']}'>
                                <textarea name='description'>{$row['description']}</textarea>
                                <input type='submit' value='Update' name='update'>
                            </form>
                            <form action='delete_about.php' method='get' style='display:inline;'>
                                <input type='hidden' name='id' value='{$row['id']}'>
...
<script>
    ...
    button.addEventListener('click', function () {
        ...
        document.getElementById('about_description').value = description;

        // Update the form action to include the ID
        document.getElementById('insertForm').action = `update_about.php?id=${id}`;
        ...
        setTimeout(function() {
            alert('About section is updated successfully.');
        }, 500); // Adjust delay as necessary for your application
    });
});
</script>
