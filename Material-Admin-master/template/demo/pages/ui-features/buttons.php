...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFile)) {
            ...
            $sql = "INSERT INTO gallery (image_id, image_title, file_name, category) VALUES ('$imageId', '$imageTitle', '".basename($_FILES["image"]["name"])."', 'default')";
...
<div class="container">
    ...
    <form id="uploadForm" action="insert.php" method="post" enctype="multipart/form-data">
        ...
        <input type="text" name="image_id" id="image_id"><br><br>
